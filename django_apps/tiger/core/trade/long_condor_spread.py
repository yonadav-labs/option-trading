...
class LongCondorSpread(Trade):
    def __init__(self, stock, legs, premium_type, target_price_lower, target_price_upper):
        super().__init__('long_condor_spread', stock, legs, premium_type, target_price_lower, target_price_upper)
    ...
    def validate(self):
        ...
        assert self.right_wing_long.contract.strike > self.right_wing_short.contract.strike > self.stock.stock_price
        assert self.left_wing_long.contract.strike < self.left_wing_short.contract.strike < self.stock.stock_price
    ...
    def build(stock, left_wing_contract_1, left_wing_contract_2, right_wing_contract_1, right_wing_contract_2,
        ...
        new_trade = LongCondorSpread(stock, [left_wing_long, right_wing_long, left_wing_short, right_wing_short],
                                     premium_type,
