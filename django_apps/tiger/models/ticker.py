...
from tiger.core.security import get_call_puts_from_response
from tiger.fetcher import get_iex_quote_url, get_option_url
...
class Ticker(BaseModel):
    ...
    def get_call_puts(self, expiration_timestamp):
        ...
        url = get_option_url(self.symbol.upper(), expiration_timestamp)
        response, external_cache_id = self.get_request_cache(url)
        return get_call_puts_from_response(self, response, expiration_timestamp, external_cache_id)
