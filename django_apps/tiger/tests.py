...
class CallTradesTestCase(TestCase):
    ...
    def test_initialization(self, mock_now):
        ...
        self.assertAlmostEqual(contract.to_target_price_ratio, 0.42857142857)
        self.assertAlmostEqual(contract.to_target_price_ratio_annualized, 0.94959631065)
        self.assertAlmostEqual(contract.estimated_premium, 161.7)
        self.assertAlmostEqual(contract.break_even_price, 449.7)
        self.assertAlmostEqual(contract.to_break_even_ratio, 0.07071428571)
        self.assertAlmostEqual(contract.to_break_even_ratio_annualized, 0.13643051577)
        self.assertAlmostEqual(contract.to_strike, -132.0)
        self.assertAlmostEqual(contract.to_strike_ratio, -0.31428571428)
        self.assertAlmostEqual(contract.to_strike_ratio_annualized, -0.50649259097)
        self.assertEqual(contract.days_till_expiration, 195)
        self.assertAlmostEqual(contract.gain, 0.9294990723562)
        self.assertAlmostEqual(contract.gain_daily, 0.00337625301)
        self.assertAlmostEqual(contract.gain_annualized, 2.42210783034)
        self.assertAlmostEqual(contract.gain_after_tradeoff, 1.5794990723562)
        self.assertAlmostEqual(contract.to_target_price_ratio, 0.42857142857143)
    ...
    def test_sell_covered_call(self, mock_now):
        ...
        self.assertAlmostEqual(contract.gain_cap_annualized, 0.13643051577)
        self.assertAlmostEqual(contract.premium_gain, 0.07071428571)  # premium_gain is capped by gain_cap.
        self.assertAlmostEqual(contract.premium_gain_annualized, 0.13643051577)
        ...
        self.assertAlmostEqual(contract2.gain_cap_annualized, 0.49873298736)
        self.assertAlmostEqual(contract2.premium_gain, 0.18178571428)
        self.assertAlmostEqual(contract2.premium_gain_annualized, 0.3670287040215)
