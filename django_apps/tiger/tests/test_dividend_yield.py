...
class TestDividendYields(TestCase):
    ...
    def test_implied_yield(self):
        '''
         ...
         We would expect that the implied dividend yield would be 0.043584, or 4.358%.
        '''
        
        expected_yield = 0.043584
    ...
    def test_both_dividend_yields(self):
        ...
        div_yields = get_div_yield(
            self.past_12, 
            self.next_div, 
            self.dividends_per_year, 
            self.current_price
        )
