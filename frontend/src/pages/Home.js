            ...
            <div className="container marketing">
                ...
                <div className="row featurette">
                    ...
                    <div className="col-md-5">
                        <img className="featurette-image img-fluid mx-auto" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" />
                    </div>
                </div>
