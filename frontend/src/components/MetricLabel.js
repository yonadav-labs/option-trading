...
const HelpTextDict = {
    ...
    'last': 'Price from the most recent transaction.',
    'last price': 'Price from the most recent transaction.',
    ...
    'order net credit': 'The initial payback received to open position for this strategy per contract/spread. This is not profit.',
